    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".sys-item").on('click', function(){
                ...
                console.log(name);
                $('#frame-id').attr('src', '${pageContext.request.contextPath}/'+name + '/findAll.do');
            });
        });
            ...
            <div class="clear-bottom head">
                <div class="container head-cc">
                    ...
                    <div class="welcome">
                        ...
                        <div class="right">${userBack.nickname}</div>
                        <div class="exit">
                        <a style="color: inherit;" href="${pageContext.request.contextPath}/user/cancel.do" >退出</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-flude flude-cc" id="a">
                <div class="row user-setting">
                    <div class="col-xs-3 user-wrap">
                        <ul class="list-group">
                            <li class="list-group-item sys-item active" name="user" >
                                <i class="glyphicon glyphicon-user"></i> &nbsp;用户管理
                            </li>
                            <li class="list-group-item sys-item" name="course" >
                                <i class="glyphicon glyphicon-facetime-video"></i> &nbsp;课程管理
                            </li>
                            <li class="list-group-item sys-item" name="courseTypeSet" >
                                <i class="glyphicon glyphicon-list"></i> &nbsp;课程类别管理
                            </li>
                            <li class="list-group-item sys-item" name="resource" >
                                <i class="glyphicon glyphicon-file"></i> &nbsp;资源管理
                            </li>
                            <li class="list-group-item sys-item" name="comment" >
                    ...
                    <div class="col-xs-9" id="userPanel">
                        <iframe id="frame-id" src="${pageContext.request.contextPath}/user/findAll.do" width="100%" height="100%" frameborder="0" scrolling="yes"></iframe>
                    </div>
                </div>
            </div>
            <!-- content end-->
