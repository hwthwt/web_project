...
//                 location.href= ".../pageNo=" + page;
			...
			$.ajax({
				type:"post",
				url:"${pageContext.request.contextPath}/comment/check.do",
				data:{
				...
				success:function(result){
					if(result.responseCode == "2001"){
						location.href="${pageContext.request.contextPath}/comment/showSelect.do?pageNo=1";    				
    				}else{
    					$("#errorMsg").tooltip({
    						title:"error",
    						placement:"center",
    				...
    				setTimeout(function(){
    						location.href="${pageContext.request.contextPath}${commentsrc}"+pageNo;
    					},1000);
				}
                ...
                <form  class="form-horizontal" >
                    <div class="form-group">
                        <div class="form-group col-xs-6">
                            ...
                            <div class="col-xs-8">
                                <input name="loginName" type="text" class="form-control" id="user-name" placeholder="请输入用户名" />
                            </div>
                        </div>
                        <div class="form-group col-xs-6">
                            <label for="user-comment" class="col-xs-3 control-label">评论内容：</label>
                            <div class="col-xs-8">
                                <input name="text" type="text" class="form-control" id="user-comment" placeholder="请输入评论内容" />
                            </div>
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="form-group col-xs-6">
                            ...
                            <div class="col-xs-8">
                                <input  id="beginTime" type="text" class="form-control" placeholder="请输入评论开始时间:2017-10-10" />
                            </div>
                        </div>
                        <div class="form-group col-xs-6">
                            <label class="col-xs-3 control-label">结束日期：</label>
                            <div class="col-xs-8">
                                <input id="endTime" type="text" class="form-control" placeholder="请输入评论结束时间:2017-10-12" />
                            </div>
                        </div>
                    </div>
