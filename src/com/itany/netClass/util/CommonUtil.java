...
public class CommonUtil {
	 ...
	 *            需要封装的对象
	 */
	public static void getObj(HttpServletRequest request, Object obj) {
	 ...
	 *            需要封装的对象
	 */
	public static void getObj(Map<String, String[]> paramsMap, Object obj) {
		...
		for (String key : keySet) {
			...
			if (null != arr && arr.length > 0) {
				...
				if (key.contains(".")) {// 含有点
					...
					try {
						...
						System.out.println("invoke=" + fieldValue + "="
								+ f.getName() + "=" + arr[0]);
						setProperty(fieldValue, f.getName(), arr[0]);
				...
				setProperty(obj, key, arr[0]);
			}
		}
	}

	private static void setProperty(Object obj, String filedName, String value) {
		Class<?> c = obj.getClass();
		Field f = null;
		try {
	...
	public static void main(String[] args) {
		...
		properties.put("username", new String[] { "xxxxx" });
		properties.put("nickname", new String[] { "hhhhhhhhhhhh" });
		properties.put("createDate", new String[] { "2018-05-21" });
		// properties.put("createDate", new String[]{ "2018-05-21 10:10:10" });
		properties.put("id", new String[] { "222222" });
		properties.put("type.id", new String[] { "2466666" });
		getObj(properties, obj);
		System.out.println(obj);
		System.out.println(obj.getType().getId());
